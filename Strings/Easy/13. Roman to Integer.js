...
var romanToInt = function(s) {
    ...
    /*
    If the current symbol is greater than or equal to the next symbol: add a + sign at the front of the current number.
    Otherwise, add a - sign in front of the current symbol
    */
    ...
    result += symbolValues[s[s.length - 1]];
    return result;
};
